...
Admin-facing management of member point balances: a configurable global redemption ratio, manual balance adjustments with an auditable reason, and an immutable per-member ledger.
