...
Defines how the system provisions the superadmin Firebase Auth account via a CLI seed script, enforces single-superadmin constraints, and ensures superadmin identity is never persisted to Firestore.
