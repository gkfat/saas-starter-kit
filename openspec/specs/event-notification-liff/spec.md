# Event Notification LIFF Spec

## Purpose

Provides LIFF-facing event notifications: an API for signed-in members to fetch currently active events and view event detail, plus home page banner/notification rendering, gated by permission-free authentication and a feature flag.
