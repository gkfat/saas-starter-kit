...
Member-facing display of point balance and history in the LIFF app: on the member card, on a standalone read-only QR/barcode page, and on a point transaction history page.
