...
Allows users to view all timestamps across the app in a timezone of their choosing, defaulting to UTC+8, with the selection persisted across sessions. Timezone conversion happens entirely in the browser; the backend continues to store and transmit UTC ISO 8601 strings.
