# Coupon Redemption Spec

## Purpose

Provides serial-code-based coupon redemption for store staff, with transactional safety guaranteeing a coupon can be redeemed at most once under concurrent requests.
