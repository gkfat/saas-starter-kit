...
LIFF-side member booking flow: browsing enabled services and their time slots, optional provider selection, confirmation before submission, creating/viewing/cancelling bookings, and a home page summary of the member's next upcoming booking.
