...
Global, build-time module on/off switches (`auditLog`, `loginLog`) controlled by environment variables, shared consistently between server and client via `runtimeConfig.public`.
