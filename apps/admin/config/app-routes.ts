...
export const ROUTES = {
  ...
  bookingServices: '/admin/booking/services',
  bookingSlotTemplates: '/admin/booking/slot-templates',
  bookingBookings: '/admin/booking/bookings',
  bookingProviders: '/admin/booking/providers',
  iamRoles: '/iam/roles',
...
export const APP_ROUTES: RouteGroup[] = [
  ...
  {
    label: 'nav.groupBooking',
    items: [
      {
        title: 'nav.bookingSlotTemplates',
        icon: 'mdi-calendar-multiselect-outline',
        path: ROUTES.bookingSlotTemplates,
        exact: true,
        permission: Permission.Bookings.Read,
        featureFlag: FeatureFlag.Booking,
      },
      {
        title: 'nav.bookingServices',
      ...
      {
        title: 'nav.bookingBookings',
        icon: 'mdi-calendar-clock-outline',
        path: ROUTES.bookingBookings,
        exact: true,
        permission: Permission.Bookings.Read,
        featureFlag: FeatureFlag.Booking,
      },
      {
        title: 'nav.bookingProviders',
        icon: 'mdi-account-tie-outline',
        path: ROUTES.bookingProviders,
        exact: true,
        permission: Permission.Bookings.Read,
        featureFlag: FeatureFlag.Booking,
      },
